...
static void printEnvData(void *pvParameters)
{
    ...
    if ( RETCODE_OK == returnValue)
    {
        ...
        //printf("BME280 Environmental Raw Data :\n\rp =%ld\n\rt =%ld\n\rh =%ld\n\r", (long int) bme280lsb.pressure, (long int) bme280lsb.temperature, (long int) bme280lsb.humidity);
    }
    else
    {
    ...
    if ( RETCODE_OK == returnValue)
    {
        ...
        */
    	temperature = (long int) bme280.temperature;
        humidity = (long int) bme280.humidity;
        pressure = (long int) bme280.pressure;
